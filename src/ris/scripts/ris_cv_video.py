...
from sensor_msgs.msg import CompressedImage #collects the specific message types.
from cv_bridge import CvBridge, CvBridgeError #Converts between ROS image format and OpenCV numpy arrays
