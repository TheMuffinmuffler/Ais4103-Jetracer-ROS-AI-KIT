...
class ArucoProcessor:
    def __init__(self):
        ...
        self.debug_image_pub = rospy.Publisher("/aruco/debug_image", Image, queue_size=5)
        self.debug_compressed_pub = rospy.Publisher("/aruco/debug_image/compressed", CompressedImage, queue_size=5)
